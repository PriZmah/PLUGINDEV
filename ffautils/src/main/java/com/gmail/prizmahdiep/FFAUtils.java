...
public class FFAUtils extends JavaPlugin
{
    ...
    public void onEnable()
    {
        ...
        command_handler.registerCommands(spawn_manager, kit_manager, ffa_players_manager, kit_editor_manager, selector_manager, minimessage_serializer);
    ...
    {
        getServer().getPluginManager().registerEvents(new PlayerJoinQuitListener(spawn_manager, ffa_players_manager), this);
        getServer().getPluginManager().registerEvents(new FFAListener(spawn_manager, kit_manager, ffa_players_manager, this, kit_editor_manager), this);
